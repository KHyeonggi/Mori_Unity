...
public class QuestManager : MonoBehaviour
{
    ...
    void GenerateDeta() //퀘스트 내용
    {
        ...
        questList.Add(40, new QuestData("바람의 시험", new int[] { 3000,6000 })); 
        questList.Add(50, new QuestData("퀘스트 완료 - 바람의 시험", new int[] { 3000 }));
        questList.Add(60, new QuestData(" ", new int[] { 0 }));
    }
